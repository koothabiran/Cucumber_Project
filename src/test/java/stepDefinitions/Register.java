...
public class Register {
	...
	public void user_should_get_successfully_registered() throws Throwable {
	    
		
	String url =driver.getCurrentUrl();
	
	if(url.equals("http://tutorialsninja.com/demo/index.php?route=account/sucess")) {
		
		System.out.println("User Register the account successfully");
		
		
	}else {
		
		System.out.println("User not register the account successfully");
		
		Assert.fail("User not register the account successfully");
